...
public class C05_ExplicitWait {
    ...
    public  void test01(){
       ...
       //WebElement itsGoneText = driver.findElement(By.id("message"));
        ...
        WebElement itsGoneText = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("message")));
        ...
        WebElement itsBackText = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("message")));
